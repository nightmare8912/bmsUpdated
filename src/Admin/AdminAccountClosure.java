...
public class AdminAccountClosure extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource()==approveBTN){
            ...
            String sql5="UPDATE fd set breakDate=curdate(), status='CLOSED' where accNum='" + accNum + "' and status='active'";
            String sql6="insert into transactions values ("+accNum+","+balS+","+balS+",'ACC_CLOS_SETLMT',curdate())";
            try{
                ConnectionSQL c=new ConnectionSQL();
